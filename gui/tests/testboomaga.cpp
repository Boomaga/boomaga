 ...
 *
 ************************************************/
void TestBoomaga::test_envInfo_getValue()
{
    QFETCH(QByteArray,  data);
    QFETCH(QString,     key);
    QFETCH(QString,     expected);

    QString result = getValue(data, key);
 ...
 *
 ************************************************/
void TestBoomaga::test_envInfo_getValue_data()
{
    ...
    QTest::newRow("05")
            << QByteArray("WAYLAND_DISPLAY=wayland-0\0",
                          26)
            << "DISPLAY"
            << "";
    ...
    QTest::newRow("07")
            << QByteArray("DISPLAY=:1\0"
                          "WAYLAND_DISPLAY=wayland-0\0",
                          37)
            << "DISPLAY"
            << ":1";
