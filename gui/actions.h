...
class PageAction: public QAction
{
    Q_OBJECT
public:
    explicit PageAction(Sheet *sheet, Page *page, QObject* parent):
        QAction(parent),
        mSheet(sheet),
        mPage(page)
    {}

    PageAction(const QString &text, Sheet *sheet, Page *page, QObject* parent):
        QAction(text, parent),
        mSheet(sheet),
        mPage(page)
    {}

    PageAction(const QIcon &icon, const QString &text, Sheet *sheet, Page *page, QObject* parent):
